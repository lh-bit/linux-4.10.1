...
module_param_named(osnet_enable_hlt_exiting,
                   ...
                   bool,
                   0644);
MODULE_PARM_DESC(osnet_enable_hlt_exiting,
...
EXPORT_SYMBOL_GPL(osnet_vmx_enable_intercept_msr_x2apic);
#endif
...
static __init int hardware_setup(void)
{
  ...
  /* OSNET-DTID
   * vmx-4.10.1 virtualizes some the LAPIC register reads
   * except for timer current counter register (TMCCT). TMCCT
   * is always trapped in KVM.
   */
